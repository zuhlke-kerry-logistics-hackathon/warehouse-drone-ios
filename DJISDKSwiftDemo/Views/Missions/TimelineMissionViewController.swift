...
class TimelineMissionViewController: BaseViewController, UICollectionViewDelegate, UICollectionViewDataSource, MKMapViewDelegate {
    ...
    override class func storyboardIdentifier() -> String {
        return "TimelineMissionViewController"
    }
